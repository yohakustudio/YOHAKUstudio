...
const translations = {
  jp: {
    ...
    bio_nat: 'タイを拠点に活動する新進気鋭のアーティスト。独自の色彩感覚とストリートテイストを融合させた作品が特徴で、代表作「KNN.FIVE FIRE-BOY」などで注目を集める。',
  ...
  en: {
    ...
    bio_nat: 'An up-and-coming artist based in Thailand. Featuring a unique sense of color fused with street taste, their masterpiece "KNN.FIVE FIRE-BOY" is gathering attention.',
  ...
  th: {
    ...
    bio_nat: 'ศิลปินหน้าใหม่ที่ประจำอยู่ในประเทศไทย โดดเด่นด้วยการผสมผสานสีสันที่เป็นเอกลักษณ์เข้ากับสไตล์สตรีท ได้รับความสนใจจากผลงานชิ้นเอก "KNN.FIVE FIRE-BOY"',
