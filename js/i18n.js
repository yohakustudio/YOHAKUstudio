...
const translations = {
  jp: {
    ...
    home_desc_s2_title: 'Online Museum', home_desc_s2_text: '精緻な造形や世界観をいつでも鑑賞できるオンライン展示。アートに没入するギャラリー体験を。',
    home_desc_s3_title: 'Global Agent', home_desc_s3_text: '単なる販売店ではなく、アーティストの代理として世界中でのプロモーション・流通を担うエージェント。',
    home_featured_label: '02 — Featured', home_featured_title: '注目のアーティスト', home_featured_link: 'すべてのアーティストを見る',
    home_store_label: '03 — Store', home_store_title: '最新入荷', home_store_link: 'ストアを見る',
    home_news_label: '04 — News', home_news_title: 'お知らせ', home_news_link: 'すべてのニュースを見る',
    ...
    bio_zhila: '独自のストリートカルチャーと怪獣を絶妙にミックスしたネコ型ソフビアート。精緻なディテールと圧倒的な存在感を放ち、世界中のコレクターからの熱烈な支持を集めている気鋭の存在。',
    bio_kenzo: '東京出身。日本の妖怪・鬼をモチーフにした迫力のソフビ作品を制作。国内外のコレクターから高い評価を受ける。ダークでありながら精緻な造形美が特徴。',
    bio_mika: '大阪出身。パステルカラーとカワイイ美学を融合させたソフビキャラクターで人気。SNSを中心に世界中にファンを持つ。',
    bio_leo: 'バンコク出身。タイの伝統神話とストリートアートを融合させた大型ソフビ作品が世界的に注目を集めている。',
    bio_lumi: '国籍非公開のアートユニット。透明素材と淡いパステルカラーを駆使し、光を美しく透過する幻想的な生き物を生み出す。「LUMI」シリーズは光と陰の美しさで世界的に高い評価を受けている。',
    bio_kgang: 'ストリートカルチャーとラグジュアリーを融合させた重厚感あるアートトイを展開。「GRIEF GANG」シリーズはマットブラックとゴールドの配色で、ファッションアイコンとしても人気が高い。',
    bio_nut: 'タイを拠点に活動する新進気鋭のアーティスト。独自の色彩感覚とストリートテイストを融合させた作品が特徴で、代表作「KNN.FIVE FIRE-BOY」などで注目を集める。',
    bio_panpan: 'キャラクターが持つ愛らしさと独自のファンタジー世界を表現するアーティスト。「GHOST」や「NANA」など、バリエーション豊かなキャラクターを生み出し、SNSを通じて世界中のファンから愛されている。',
    ...
    contact_email_label: 'Email', contact_sns_label: 'Instagram', contact_base_label: 'Base', contact_base_text: 'Japan / Thailand',
    contact_entry_label: 'Artist Entry', contact_entry_text: '作品をお持ちのアーティストの方、YOHAKUstudioとの協力を希望される方は、種別を「アーティストエントリー」あるいはArtist Entryとしてお問い合わせください。お名前・活動国・SNSリンクもご記載ください。',
    ...
    news_item0_date: '2026.03.25', news_item0_title: 'ZHILAの最新カラープロトタイプが完成しました',
  ...
  en: {
    ...
    home_desc_s2_title: 'Online Museum', home_desc_s2_text: 'Appreciate elaborate forms and immersive worldviews. A virtual space dedicated to viewing fine art.',
    home_desc_s3_title: 'Global Agent', home_desc_s3_text: 'More than a shop, we act as an agent with global connections for promotion, support, and distribution.',
    home_featured_label: '02 — Featured', home_featured_title: 'Featured Artists', home_featured_link: 'View All Artists',
    home_store_label: '03 — Store', home_store_title: 'New Arrivals', home_store_link: 'Visit Store',
    home_news_label: '04 — News', home_news_title: 'News', home_news_link: 'View All News',
    ...
    bio_zhila: 'A feline sofubi art piece that exquisitely mixes unique street culture with kaiju. Featuring fine details and an overwhelming presence, this up-and-coming artist has garnered passionate support from collectors worldwide.',
    bio_kenzo: 'Born in Tokyo. Creates powerful sofubi works with motifs of Japanese yokai and oni. Highly acclaimed by collectors domestically and internationally, featuring dark yet precise formative beauty.',
    bio_mika: 'Born in Osaka. Popular for sofubi characters combining pastel colors and kawaii aesthetics. Has fans worldwide, mainly on social media.',
    bio_leo: 'Born in Bangkok. Gaining worldwide attention for large sofubi works that fuse Thai traditional mythology and street art.',
    bio_lumi: 'An art unit of undisclosed nationality. Utilizing transparent materials and pale pastel colors, they create fantastical creatures that beautifully transmit light. The "LUMI" series is highly acclaimed worldwide for the beauty of its light and shadow.',
    bio_kgang: 'Develops profound art toys blending street culture and luxury. The "GRIEF GANG" series, featuring matte black and gold color schemes, is highly popular as a fashion icon.',
    bio_nut: 'An up-and-coming artist based in Thailand. Featuring a unique sense of color fused with street taste, their masterpiece "KNN.FIVE FIRE-BOY" is gathering attention.',
    bio_panpan: 'An artist expressing the adorableness of characters and a unique fantasy world. Creating a rich variety of characters such as "GHOST" and "NANA", they are loved by fans worldwide through SNS.',
    ...
    contact_email_label: 'Email', contact_sns_label: 'Instagram', contact_base_label: 'Base', contact_base_text: 'Japan / Thailand',
    contact_entry_label: 'Artist Entry', contact_entry_text: 'Artists with their own works and those who wish to collaborate with YOHAKUstudio, please select "Artist Entry" as the enquiry type. Please also include your name, country of activity, and SNS links.',
    ...
    news_item0_date: '25.03.2026', news_item0_title: "ZHILA's latest color prototype has been completed",
  ...
  th: {
    ...
    home_desc_s2_title: 'Online Museum', home_desc_s2_text: 'ชมความงามของงานปั้นและโลกทัศน์ได้ทุกเมื่อ เป็นพื้นที่สำหรับสำรวจศิลปะชั้นเลิศออนไลน์',
    home_desc_s3_title: 'Global Agent', home_desc_s3_text: 'ไม่ใช่แค่ร้านค้า แต่เราเป็นตัวแทนคอยจัดโปรโมทและกระจายผลงานของศิลปินสู่ระดับสากล',
    home_featured_label: '02 — แนะนำ', home_featured_title: 'ศิลปินแนะนำ', home_featured_link: 'ดูศิลปินทั้งหมด',
    home_store_label: '03 — ร้านค้า', home_store_title: 'สินค้ามาใหม่', home_store_link: 'เยี่ยมชมร้านค้า',
    home_news_label: '04 — ข่าวสาร', home_news_title: 'ข่าวสาร', home_news_link: 'ดูข่าวสารทั้งหมด',
    ...
    bio_zhila: 'ศิลปะซอฟบี้รูปแมวที่ผสมผสานวัฒนธรรมสตรีทที่เป็นเอกลักษณ์เข้ากับสัตว์ประหลาด (ไคจู) ได้อย่างลงตัว ด้วยรายละเอียดที่ละเอียดอ่อนและรูปลักษณ์ที่โดดเด่น ศิลปินดาวรุ่งผู้นี้จึงได้รับการสนับสนุนอย่างล้นหลามจากนักสะสมทั่วโลก',
    bio_kenzo: 'เกิดที่โตเกียว สร้างสรรค์ผลงานซอฟบี้สุดทรงพลังที่ได้รับแรงบันดาลใจจากโยไคและโอนิของญี่ปุ่น ได้รับการยกย่องอย่างสูงจากนักสะสมทั้งในและต่างประเทศ โดดเด่นด้วยความงามทางรูปทรงที่ทั้งดุดันและประณีต',
    bio_mika: 'เกิดที่โอซาก้า มีชื่อเสียงจากตัวละครซอฟบี้ที่ผสมผสานสีพาสเทลและสุนทรียศาสตร์ความน่ารัก มีแฟนคลับทั่วโลกโดยเฉพาะบนโซเชียลมีเดีย',
    bio_leo: 'เกิดที่กรุงเทพฯ ได้รับความสนใจจากทั่วโลกด้วยผลงานซอฟบี้ขนาดใหญ่ที่ผสมผสานตำนานดั้งเดิมของไทยและสตรีทอาร์ต',
    bio_lumi: 'กลุ่มศิลปินที่ไม่เปิดเผยสัญชาติ ใช้วัสดุโปร่งใสและสีพาสเทลอ่อนเพื่อสร้างสิ่งมีชีวิตมหัศจรรย์ที่แสงสามารถส่องผ่านได้อย่างสวยงาม ซีรีส์ "LUMI" ได้รับการยกย่องทั่วโลกในเรื่องความงามของแสงและเงา',
    bio_kgang: 'นำเสนออาร์ตทอยที่ดูลุ่มลึกโดยผสมผสานวัฒนธรรมสตรีทและความหรูหราเข้าด้วยกัน ซีรีส์ "GRIEF GANG" ที่ใช้โทนสีดำด้านและสีทองเป็นที่นิยมสูงมากในฐานะแฟชั่นไอคอน',
    bio_nut: 'ศิลปินหน้าใหม่ที่ประจำอยู่ในประเทศไทย โดดเด่นด้วยการผสมผสานสีสันที่เป็นเอกลักษณ์เข้ากับสไตล์สตรีท ได้รับความสนใจจากผลงานชิ้นเอก "KNN.FIVE FIRE-BOY"',
    bio_panpan: 'ศิลปินผู้ถ่ายทอดความน่ารักของตัวละครและโลกแฟนตาซีที่เป็นเอกลักษณ์ สร้างสรรค์ตัวละครหลากหลายรูปแบบเช่น "GHOST" และ "NANA" จนเป็นที่รักของแฟนๆ ทั่วโลกผ่านโซเชียลมีเดีย',
    ...
    contact_email_label: 'อีเมล', contact_sns_label: 'อินสตาแกรม', contact_base_label: 'ฐานที่ตั้ง', contact_base_text: 'ญี่ปุ่น / ไทย',
    contact_entry_label: 'สมัครศิลปิน', contact_entry_text: 'ศิลปินที่มีผลงานของตนเองและผู้ที่ประสงค์จะร่วมงานกับ YOHAKUstudio โปรดเลือกประเภทการสอบถามเป็น "สมัครศิลปิน" (Artist Entry) พร้อมทั้งระบุชื่อ ประเทศที่ดำเนินการ และลิงก์ SNS ของคุณ',
    ...
    news_item0_date: '25.03.2026', news_item0_title: 'ต้นแบบสีล่าสุดของ ZHILA เสร็จสมบูรณ์แล้ว',
