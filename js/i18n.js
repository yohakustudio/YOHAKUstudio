...
const translations = {
  ...
  en: {
    ...
    bio_zhila: 'A cat-type sofubi art that exquisitely mixes street culture and monsters. With its precise details and overwhelming presence, this up-and-coming artist is gaining passionate support from collectors worldwide.',
  ...
  th: {
    ...
    bio_zhila: 'ศิลปะซอฟบี้รูปแมวที่ผสมผสานวัฒนธรรมสตรีทและสัตว์ประหลาดอย่างลงตัว ด้วยรายละเอียดที่แม่นยำและรูปลักษณ์ที่โดดเด่น ศิลปินดาวรุ่งรายนี้จึงได้รับการสนับสนุนอย่างท่วมท้นจากนักสะสมทั่วโลก',
