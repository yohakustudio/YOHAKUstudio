...
const translations = {
  jp: {
    ...
    bio_kkuro5: 'タイ出身。代表作「ノトイ」（NOTOY）をはじめ、強烈な色彩とユニークな表情を持つ独自のアートトイを展開。そのポップな感性とキャラクター造形で国境を越えて多くのファンを魅了している。',
  ...
  en: {
    ...
    bio_kkuro5: 'Born in Thailand. Known for their masterpiece "NOTOY", they create unique art toys with striking colors and unique expressions. Their pop aesthetics and character designs captivate fans worldwide.',
  ...
  th: {
    ...
    bio_kkuro5: 'ศิลปินชาวไทย เป็นที่รู้จักจากผลงานชิ้นเอก "NOTOY" เขาสร้างสรรค์อาร์ตทอยที่ไม่เหมือนใครด้วยสีสันที่สะดุดตาและใบหน้าที่เป็นเอกลักษณ์ สไตล์ป๊อปและการออกแบบตัวละครของเขาดึงดูดแฟนๆ ทั่วโลก',
